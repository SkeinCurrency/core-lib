...
#### T3 - Require 'skeincore' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the skeincore object.

DO:

```javascript
var skeincore = require('../');
var PublicKey = skeincore.PublicKey;
```
